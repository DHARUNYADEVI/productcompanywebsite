...
header{
    background-image: url(software.jpeg);
    height: 100vh;
...
<body style="background-image: url(software.jpg);">
    <header>
        <div class="main">
            <ul>
        ...
        <div class="logo">
            <img src="zohologo.png" alt="" width="200px" height="100px">
        </div>
        <div class="title">
...
<body>
    ...
    <div class="search" >
        ...
        <div class="cirpic">
            <img class="small border" src="image01.png" width="400px">
            <img class="small border" src="image2.png" width="400px" >
            <img class="small border" src="image3.png" width="400px">
            <img class="small border" src="image4.png" width="400px" >
            <img class="small border" src="image5.png" width="400px">
            <img class="small border" src="image6.png" width="400px" >
        </div>
        <div class ="text">
        ...
        <div class="text2">
            ...
            <footer>
                Designed and Developed by DHARUNYADEVI S&copy; 2023
                </footer>
...
<body>
  <header>
   ...
   <div class="h1">
    <h1> SERVICES GOING ON BY ZOHO>!</h1>
    </div>
    <div class="im">
<img src="service.png" alt="" width="600px" height="450px">
</div>
  <footer>
    <p>Designed And Developed By: DHARUNYADEVI S &copy;2023</p>
</footer>
...
.srch:focus{
    ...
    <body>
        <header>
            ...
            <div class="logo">
                <img src="zohologo.png" alt="" width="150px" height="100px">
            </div>
            <div class="coform">
            <form>
              <h3>&nbsp;Contact Us</h3>
        ...
        <div class="info">
            ...
            <b>Address: </b>Office No.-3, Shalom Building, 4, Mannar St, T. Nagar, Chennai, Tamil Nadu 600017 <br><br>
            <b>Email: </b>info@zohocorp.com<br>
            <b>Phone: </b>
